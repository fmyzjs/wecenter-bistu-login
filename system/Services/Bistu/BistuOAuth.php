...
/**
 *  Bistu  OAuth 认证类(OAuth2)
 *
 * 授权机制说明请大家参考 Bistu 开放平台文档：{@link }
 *
 * @package iflab
 * @author Elmer Zhang, Jason Zhu
 * @version 1.0
 */
class ifLabTOAuthV2 {
	/**
	 ...
	 * @ignore
	 */
	public $host = "https://222.249.250.89:8443/";
    /**
	 * Set up the API root URL.
	 *
	 * @ignore
	 */
	public $userinfoURL = "https://222.249.250.89:8443/m/userinfo.htm";
	/**
	 * Set timeout default.
	 *
	 * @ignore
	 ...
	 * @ignore
	 */
	public $useragent = 'ifLab T OAuth2 v0.1';
	 ...
	 * @ignore
	 */
	function accessTokenURL()  { return 'https://222.249.250.89:8443/oauth/token'; }
	/**
	 * @ignore
	 */
	function authorizeURL()    { return 'https://222.249.250.89:8443/oauth/authorize'; }
	 ...
	 * @return array
	 */
	function getAuthorizeURL( $url, $response_type = 'code', $state = 'wecenter', $display = NULL ) {
		$params = array();
 ...
 *
 * @package iflab
 * @author Easy Chen, Elmer Zhang,Lazypeople, Jason Zhu
 * @version 1.0
 */
class ifLabTClientV2
{
	/**
	 * 构造函数
	 * 
	 * @access public
	 * @param mixed $akey  Bistu 开放平台应用APP KEY
	 * @param mixed $skey  Bistu 开放平台应用APP SECRET
	...
	{
		$this->oauth = new ifLabTOAuthV2( $akey, $skey, $access_token, $refresh_token );
	}
	 ...
	 * @return array
	 */
	function account_profile_basic()
	{
	    return $this->oauth->get( 'https://222.249.250.89:8443/m/userinfo.htm' , $params );
	}
	 ...
	 * 对应API：{@link }
	 *
	 * @param string $userid ,string $idtype
	 * @return array
	 */
	function account_email( $userid, $idtype = NULL )
	{
		//TOOD
	}
...
class Services_Bistu_BistuOAuth extends ifLabTOAuthV2
{
...
class Services_Bistu_BistuClient extends ifLabTClientV2
{
	function __construct( $akey, $skey, $access_token = NULL, $refresh_token = NULL )
	{
		parent::__construct( $akey, $skey, $access_token, $refresh_token );
